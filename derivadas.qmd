...
:::{#exr-extremos-6}
Un hotel alquila habitaciones por un precio entre 40€ y 100€ diarios. Se ha observado que el número de habitaciones que alquilan depende del precio $x$ según la función $h(x)=300-3x$. ¿Qué precio se debe cobrar por habitación para obtener el máximo beneficio?
:::
