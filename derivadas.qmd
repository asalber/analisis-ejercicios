...
:::{.callout-tip collapse="true"}
## Solución
a. El punto $(x_0,y_0)$ en el que se encontrará el cuerpo cuando $x_0=\pi/2$
cumple la ecuación del enunciado. Por lo tanto:
$$
2e^{x_0y_0} \operatorname{sen}(x)_0 + y_0\cos(x)_0 = 2
$$
y sustituyendo $x_0=\pi/2$, obtenemos:
$$
2e^{\frac{\pi }{2}y_0 } \operatorname{sen}\frac{\pi }{2} + y_0 \cos \frac{\pi }{2}
...
$$
y' = \frac{{ - 2e^{xy} y \operatorname{sen}(x) - 2e^{xy} \cos(x) + y \operatorname{sen}
x}}{{2xe^{xy} \operatorname{sen}(x) + \cos(x)}}
$$
Teniendo en cuenta que $x_0=0$, y sustituyendo en la expresión
inicial, obtenemos el valor de $y_0$:
$$
2e^0 \operatorname{sen} 0 + y_0 \cos 0 = 2 \Rightarrow y_0  = 2
$$
...
a.  Obtener el polinomio de Taylor de tercer grado de $f$ en el punto $x=\pi/6$ y usarlo para aproximar $\operatorname{sen}(1/2)$ dando una cota del error cometido.
a.  Dar una aproximación de $\operatorname{sen}(1/2)$ usando un el polinomio de Taylor de quinto grado en el punto $x=0$, acotando el error cometido.
:::

<!--
:::{.callout-tip collapse="true"}
## Solución
a. $P^3_{f,\pi/6}(x) = \frac{1}{2}+\frac{\sqrt{3}}{2}(x-\pi/6)-\frac{1}{4}(x-\pi/6)^2-\frac{\sqrt{3}}{12}(x-\pi/6)^3$.\\
$\sen 1/2 \approx P^3_{f,\pi/6}(1/2) = 0.4794255322$.\\
$|R^3_{f,\pi/6}(1/2)|\leq 6.46\cdot 10^{-9}$.
a. $P^5_{f,0}(x) = x -\frac{1}{6} x^3 + \frac{1}{120}x^5$.\\
