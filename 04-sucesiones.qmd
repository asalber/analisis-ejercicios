...
## Solución
Sea $(a_n)_{n=1}^\infty$ una sucesión con $a_n = c$ constante. Veamos que converge a $c$. Para cualquier $\varepsilon>0$ basta tomar $k=1$, de manera que $\forall n\geq k$ se tiene que $|x_n-c|=|c-c| = 0 <\varepsilon$. Por tanto, $\lim_{n\to\infty}a_n =c$.
:::
