...
Una función $f(x,y)$ se llama homogénea de grado $n$ si satisface que $f(tx, ty) = t^nf(x,y)$. Demostrar que si $f$ es homogénea de grado $n4 se cumplen las ecuaciones 
