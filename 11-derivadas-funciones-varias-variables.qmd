...
\Leftrightarrow t^{n-1}\frac{\partial f(x,y)}{\partial x}x + t^{n-1}\frac{\partial f(x,y)}{\partial y}y =  nt^{n-1}f(x,y) \\
\Leftrightarrow \frac{\partial f(x,y)}{\partial x}x + \frac{\partial f(x,y)}{\partial y}y =  nf(x,y).
\end{gathered}
$$
...
Demostrar que si $f(x,y)$ es una función de varias variables tal que $x$ e $y$ dependen, a su vez, de otras dos variables, $u$ y $v$, es decir, $x=x(u,v)$ e $y=y(u,v)$, entonces 
