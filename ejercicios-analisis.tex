...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, sharp corners, enhanced, borderline west={3pt}{0pt}{shadecolor}, boxrule=0pt, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toptitle=1mm, arc=.35mm, breakable, toprule=.15mm, opacitybacktitle=0.6, colback=white, coltitle=black, titlerule=0mm, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, bottomrule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, left=2mm]
...
\leavevmode\vadjust pre{\hypertarget{exr-sucesion-divergente}{}}%
\begin{exercise}[]\label{exr-sucesion-divergente}
...
siguientes sucesiones convergen a los valores dados.
