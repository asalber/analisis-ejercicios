...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, borderline west={3pt}{0pt}{shadecolor}, enhanced, boxrule=0pt, frame hidden, sharp corners, interior hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, coltitle=black, colframe=quarto-callout-tip-color-frame, opacityback=0, colback=white, bottomrule=.15mm, left=2mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, opacitybacktitle=0.6, leftrule=.75mm, toptitle=1mm, titlerule=0mm, arc=.35mm]
...
que cada término se obtienen sumando un número constante al anterior, es
decir, \(x_{n+1} = c+x_n\). Estudiar la convergencia de las sucesiones
aritméticas.
...
que cada término se obtienen multiplicando un número constante al
anterior, es decir, \(x_{n+1} = cx_n\). Estudiar la convergencia de las
...
converge un número \(l\), entonces la sucesión \((x_n-l)_{n=1}^\infty\)
converge a \(0\).
...
Demostrar que si una sucesión de números reales positivos converge a
...
Demostrar las siguientes sucesiones convergen a \(0\) usando el teorema
de compresión de sucesiones.
...
\tightlist
\item
  \((\frac{3n}{2n^2})_{n=1}\infty\)
\item
  \(x_1=1\) y \(x_{n+1}=\frac{a_n+3}{2}\) \(\forall n\in\mathbb{N}\)
\item
  \((\frac{n^2}{2n+1})_{n=1}^\infty\)
\item
  \(x_1=2\) y \(x_{n+1}=\sqrt{x_n+2}\) \(\forall n\in\mathbb{N}\)
\item
  \(x_1=1\) y \(x_{n+1}=\sqrt{2x_n}\) \(\forall n\in\mathbb{N}\)
\end{enumerate}
