...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, bottomtitle=1mm, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, left=2mm, toptitle=1mm, breakable, titlerule=0mm, arc=.35mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, opacityback=0, bottomrule=.15mm, rightrule=.15mm, leftrule=.75mm]
...
\item
  ...
  \(x=\pi/6\) y usarlo para aproximar \(\operatorname{sen}(1/2)\) dando
  una cota del error cometido.
\item
  Dar una aproximación de \(\operatorname{sen}(1/2)\) usando un el
  polinomio de Taylor de quinto grado en el punto \(x=0\), acotando el
  error cometido.
\end{enumerate}
