...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, borderline west={3pt}{0pt}{shadecolor}, interior hidden, enhanced, breakable, sharp corners, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, arc=.35mm, opacityback=0, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, toprule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, breakable, bottomrule=.15mm, left=2mm, colbacktitle=quarto-callout-tip-color!10!white, colframe=quarto-callout-tip-color-frame, colback=white, titlerule=0mm, rightrule=.15mm, coltitle=black]
...
Consideremos, en primer lugar, la función \(\sen x\), y calculemos sus
...
sustituir \(\sen x\) por \(P_{0}^{3}(x)\) y \(\operatorname{tg}(x)\) por
\(Q_{0}^{3}(x)\), teniendo en cuenta dichos polinomios se comportan de
igual forma que las correspondientes funciones en un entorno del 0. Así
pues, tenemos: \[
...
\item
  ...
  \end{align*} Sustituyendo para \(t=0\) tenemos: \begin{align*}
...
Y por último, sustituyendo en la ecuación \ref{e:Maclaurin} llegamos al
polinomio \[
