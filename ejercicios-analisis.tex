...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, interior hidden, sharp corners, frame hidden, borderline west={3pt}{0pt}{shadecolor}, enhanced, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toptitle=1mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, leftrule=.75mm, coltitle=black, bottomtitle=1mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, arc=.35mm, rightrule=.15mm, left=2mm, opacitybacktitle=0.6, opacityback=0]
...
\leavevmode\vadjust pre{\hypertarget{exr-trayectorias-3}{}}%
\begin{exercise}[]\label{exr-trayectorias-3}
