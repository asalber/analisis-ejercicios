...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, frame hidden, interior hidden, sharp corners, breakable]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, opacityback=0, toptitle=1mm, leftrule=.75mm, arc=.35mm, titlerule=0mm, colframe=quarto-callout-tip-color-frame, colbacktitle=quarto-callout-tip-color!10!white, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, colback=white, toprule=.15mm, rightrule=.15mm, breakable, left=2mm, bottomtitle=1mm, coltitle=black, bottomrule=.15mm]
...
\leavevmode\vadjust pre{\hypertarget{exr-limite-funcion-exponencial}{}}%
\begin{exercise}[]\label{exr-limite-funcion-exponencial}
