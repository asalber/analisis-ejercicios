...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, boxrule=0pt, interior hidden, frame hidden, enhanced, sharp corners, borderline west={3pt}{0pt}{shadecolor}]}{\end{tcolorbox}}\fi
...
\leavevmode\vadjust pre{\hypertarget{exr-limit-emparedado}{}}%
...
\item
  \(\displaystyle \lim_{x\to a}\dfrac{\operatorname{sen}(x)-\operatorname{sen}(a)}{x-a}\)
\item
