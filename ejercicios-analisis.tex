...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, interior hidden, boxrule=0pt, enhanced, frame hidden]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, toprule=.15mm, left=2mm, colback=white, rightrule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, toptitle=1mm, titlerule=0mm, breakable, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, coltitle=black, opacityback=0, colframe=quarto-callout-tip-color-frame]
...
Demostrar que todos los números de \(\mathbb{Z}\) son puntos frontera.
