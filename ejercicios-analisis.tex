...
\end{tabular}
\end{flushleft}
\end{titlepage}\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, frame hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, sharp corners, breakable, enhanced]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solución}, arc=.35mm, opacitybacktitle=0.6, rightrule=.15mm, titlerule=0mm, opacityback=0, coltitle=black, bottomtitle=1mm, breakable, leftrule=.75mm, colback=white, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, toprule=.15mm, toptitle=1mm, colframe=quarto-callout-tip-color-frame]
...
ecuación \[
C(x) = a E(x)^b
\] donde \(a\) y \(b\) son constantes. Esta ecuación se conoce como
...
decrecimiento, extremos, concavidad y convexidad).
