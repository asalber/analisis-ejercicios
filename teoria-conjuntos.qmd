...
:::{#exr-5}
Demostrar que la relación $R=\{(x,y)\in \mathbb{Z}^2: x-y \mbox{ es par}\}$.
...
:::{.callout-tip collapse="true"}
## Solución
Ya hemos visto en el ejercicio @exr-racionales-numerables que $\mathbb{Q}$ no es numerable, de manera que si $\mathbb{R}\setminus \mathbb{Q}$ fuese numerable, entonces por el @exr-union-numerables  $\mathbb{q}\cup \mathbb{R}\setminus \mathbb{Q}=\mathbb{R}$ sería numerable, lo cual no es cierto.
:::

:::{#exr-21}
Demostrar que el conjunto de todos los polinomios con coeficientes enteros $P=\{a_0+a_1x+a_2x^2+\cdots = \sum_{i=1}^\infty a_ix^i : a_i\in \mathbb{Z}\}$ no es numerable.
:::
