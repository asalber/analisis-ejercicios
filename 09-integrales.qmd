...
0, 32, 65, 120, 142, 157, 175, 161, 133, 103, 68, 0
...
:::{#exr-volumen-toro}
Calcular el volumen de este [toro](https://www.geogebra.org/m/xugkcvn5). Calcular a continuación el volumen de un toro de radio mayor $R$ y radio menor $r$.
:::
...
:::{#exr-volumen-cuba-vino}
Una cuba para almacenar vino tiene forma parabólica, dada por la función $y=x^2$ y sus secciones transversales con respecto al eje $y$ son cuadrados. ¿Cuántos litros de vino puede almacenar la cuba si su altura es de 2 metros?
:::