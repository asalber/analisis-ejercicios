...
:::{#exr-centro-masas-1}
Una varilla varilla metálica de 20 m de longitud, tiene una densidad $d(x) = \operatorname{sen}(\pi x)$ a una distancia $x$ de su extremo izquierdo. Calcular su centro de masas.
:::

:::{#exr-centro-masas-3}
Calcular el centroide del sector circular definido por la ecuación $x^2+y^2=4$ en el primer cuadrante.
:::
...
Dar una demostración del teorema para el caso particular en el que la región plana está delimitada por dos funciones $f(x)$ y $g(x)$ en un intervalo $[a,b]$.
:::
