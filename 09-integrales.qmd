...
Un depósito metálico tiene la forma del elipsoide que se obtiene al rotar la elipse $\frac{x^2}{4}+y^2=1$ alrededor del eje $x$. Calcular la cantidad de chapa metálica necesaria para construir el depósito. ¿Y si el depósito se construye rotando la elipse alrededor del eje $y$?
:::

:::{#exr-superficie-toro}
Calcular la superficie de este [toro](https://www.geogebra.org/m/wy2uquqc) obtenido al rotar la circunferencia de ecuación $(x-2)^2+y^2=1$ alrededor del eje $y$. Calcular a continuación la superficie de un toro de radio mayor $R$ y radio menor $r$.
:::
