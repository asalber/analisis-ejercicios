...
b. $f(\theta) = e^{\theta/2}$ para $\theta\in[0,2\pi]$.
:::
...
Un criterio para estudiar la convergencia de una serie $\sum a_n$ es estudiar la integral impropia $\int_1^\infty a_n\,dn$. La serie converge si y solo si la integral es finita. Usar este criterio para demostrar que la serie armónica $\sum \frac{1}{n}$ diverge y que las serie $\sum \frac{1}{n^2}$ converge.
:::
...
$$
\int_1^\infty \frac{1}{n}\,dn = \left[\ln|n|\right]_1^\infty = \lim_{n\to\infty}\ln(n) - \ln(1)= \infty.
$$
...
$$
\int_1^\infty \frac{1}{n^2}\,dn = \left[\frac{-1}{n}\right]_1^\infty = \lim_{n\to\infty}\frac{-1}{n}-\frac{-1}{1}= 1,
$$
