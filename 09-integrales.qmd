...
=  \frac{\pi}{2} (-\operatorname{sen}(2\pi/4)) + \frac{\pi}{2} (\operatorname{sen}(2\pi/4)-\operatorname{sen}(2\pi/2)) 
= \frac{\pi}{2}+\frac{\pi}{2}
= \pi.
\end{gathered}
$$
...
:::{#exr-volumen-helado}
Un helado tiene forma parabólica dada por la función $y=1-x^2$ y sus secciones transversales con respecto al eje $y$ son cuadrados. ¿Cuál es el volumen del helado?
:::

:::{#exr-pluviometro}
Un pluviómetro tiene la forma de un sólido de revolución obtenido al rotar la función $f(x)=x^3$ alrededor del eje $y$. ¿Cuál debe ser su altura para que sea capaz de almacenar 1 litro de agua?
:::
