...
:::{#exr-volumen-helado}
Un helado tiene forma parabólica dada por la función $y=9-x^2$ (en cm) y sus secciones transversales con respecto al eje $y$ son cuadrados. ¿Cuál es el volumen del helado?
:::

:::{.callout-tip collapse="true"}
### Solución
Como las secciones transversales con respecto al eje $y$ son figuras regulares, en este caso cuadrados, calcularemos el volumen del helado integrando a lo largo del eje $y$ las áreas de esos cuadrados. Para cualquier sección transversal en $y=a$, el semi-lado del cuadrado resultante es 
...
Por otro lado, es fácil ver que el máximo de la curva $y=9-x^2$ es $y=9$ por lo que el intervalo de integración es $[0,9]$. Así pues, el volumen del helado viene dado por la siguiente integral
...
$x = f^{-1}(y) = y^{1/3}$. Por tanto, para calcular el volumen del sólido de revolución podemos tomar [discos cilíndricos](https://aprendeconalf.es/analisis-manual/09-integraleshtml#c%C3%A1lculo-de-vol%C3%BAmenes-de-s%C3%B3lidos-de-revoluci%C3%B3n), de manera que el volumen del pluviómetro de altura $h$ viene dado por la integral 

$$
\int_0^h \pi f^{-1}(y)\,dy
= \pi \int_0^h y^{1/3}\,dy
= \pi \left[\frac{y^{4/3}}{4/3}\right]_0^h
= \frac{3\pi}{4}h^{4/3}.
$$ 
...
$$
\frac{3\pi}{4}h^{4/3} = 1000 
\Leftrightarrow h^{4/3} = \frac{4000}{3\pi} 
\Leftrightarrow h = \left(\frac{4000}{3\pi}\right)^{3/4} = 93.5064 \mbox{ cm}.
$$
:::
...
:::{.callout-tip collapse="true"}
## Solución
La ecuación de la circunferencia de radio $r$ centrada en el origen es $x^2+y^2=r^2$, de donde se deduce que $y=\pm\sqrt{r^2-x^2}$. Si tomamos la función correspondiente a la semicircunferencia positiva $f(x)=\sqrt{r^2-x^2}$, podemos calcular la [longitud de la curva](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-la-longitud-de-una-curva) de la semicircunferencia con la siguiente integral
...
:::{.callout-tip collapse="true"}
## Solución
La longitud del rail es la longitud de la curva correspondiente a la gráfica de la función $f(x)=\frac{1}{3}(x-3)\sqrt{x}$. Resulta sencillo ver que las dos raíces de esta función son $x=0$ (el origen) y $x=3$, por lo que hay que el intervalo de integración es $[0,3]$. Para calcular la [longitud de la curva](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-la-longitud-de-una-curva) correspondiente a la gráfica de $f$ en este intervalo hay que calcular la siguiente integral   
...
:::{.callout-tip collapse="true"}
## Solución
La longitud del cable eléctrico es la [longitud de la curva](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-la-longitud-de-una-curva) correspondiente a la gráfica de la función $f(x)=5\cosh(x/5)$ en el intervalo $[-5,5]$, que viene dado por la integral
...
:::{.callout-tip collapse="true"}
## Solución
a.  La [superficie del sólido de revolución](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-superficies-de-s%C3%B3lidos-de-revoluci%C3%B3n) que se obtiene al rotar la gráfica de la función $f(x)$ alrededor del eje $x$ en el interavlo $[-1,1]$, viene dada por la siguiente integral
...
El [área de la superficie del sólido de revolución](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-superficies-de-s%C3%B3lidos-de-revoluci%C3%B3n) que se obtiene al rotar la gráfica de $f$ alrededor del eje $x$ en el intervalo $[a,b]$ viene dado por la integral
...
donde la rama positiva corresponde al semi-toro positivo y la negativa al semi-toro negativo. Por simetría, para calcular el área de la superficie del toro basta con calcular el área de las superficie del semi-toro positivo y multiplicarla por 2. El [área de la superficie del sólido de revolución](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-superficies-de-s%C3%B3lidos-de-revoluci%C3%B3n) que se obtiene al rotar la gráfica de una función $f$ alrededor del eje $y$ en un intervalo $[a,b]$ viene dado por la integral
...
Tal y como vimos en el [cálculo de volúmenes de sólidos de revolución](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-vol%C3%BAmenes-de-s%C3%B3lidos-de-revoluci%C3%B3n), el volumen almacenado en el depósito hasta una altura $h$ es 
...
\begin{align*}
W 
&= \int_0^{5.6419} g\delta \pi \sqrt{2y}^2 (4-y) ,dy,
= \int_0^{5.6419} 9.81\cdot 900 \pi 2y (4-y) ,dy, \\
&= 8829\pi \int_0^{5.6419} 8y-2y^2 ,dy,
= 8829\pi \left[8\frac{y^2}{2}-2\frac{y^3}{3}\right]_0^{5.6419} \\
&= 8829\pi \left(8\frac{5.6419^2}{2}-2\frac{5.6419^3}{3}\right)
= 210777.97 \mbox{ J}
\end{align*}
:::
...
:::{.callout-tip collapse="true"}
## Solución
Para calcular el [centro de masas de una varilla con densidad variable](https://aprendeconalf.es/analisis-manual/09-integrales.html#centro-de-masas-de-una-varilla-con-densidad-variable) $f(x)$ tenemos que dividir su momento y su masa, es decir, calcular el cociente de integrales 
...
Para calcular el [centro de masas una región plana con densidad constante](https://aprendeconalf.es/analisis-manual/09-integrales.html#centro-de-masas-de-una-regi%C3%B3n-plana-con-densidad-fija) $f(x)$ tenemos que calcular las coordenadas del centroide por separado. Para calcular la primera coordenada del centroide tenemos que calcular el cociente de integrales
...
:::{.callout-tip collapse="true"}
## Solución
Para calcular el [valor medio de una función](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-la-media-de-una-funci%C3%B3n) en el intervalo $[-1,1]$ tenemos que calcular la siguiente integral
...
Según las fórmulas de [cinemática](https://aprendeconalf.es/analisis-manual/09-integrales.html#cinem%C3%A1tica), la posición que ocupa la pelota en cada instante $t$ viene dada por la expresión
...
Así pues, tenemos que calcular la velocidad media en el intervalo $[0, 2.2576]$. El [valor medio de la función](https://aprendeconalf.es/analisis-manual/09-integrales.html#c%C3%A1lculo-de-la-media-de-una-funci%C3%B3n) velocidad en ese intervalo viene dado por la siguiente expresión
