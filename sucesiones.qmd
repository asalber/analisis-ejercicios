...
e. $((-1)^{n+1})_{n=1}^\infty$ y $((-1)^n)_{n=1}^\infty$ divergen, pero $(\frac{(-1)^{n+1}}{(-1)^n})_{n=1}^\infty = (\frac{(-1)^n(-1)}{(-1)^n})_{n=1}^\infty = (-1)_{n=1}^\infty$ converge al ser constante.
:::
...
:::{.callout-tip collapse="true"}
## Solución
Veamos primero el caso en que $x=0$. Supongamos que $\lim_{n\to\infty}x_n=0$. Dado $\varepsilon>0$ sea $\varepsilon_1=\varepsilon^2>0$, entonces existe $k\in\mathbb{N}$ tal que $|x_n-0|=|x|<\varepsilon_1$ $\forall n\geq k$, pero entonces, también se cumple que 
...
a. $x_1=1$ y $x_{n+1}=\frac{a_n+3}{2}$ $\forall n=2,3,\ldots$

a. $\left(\frac{n^2}{2n+1}\right)_{n=1}^\infty$

a. $x_1=2$ y $x_{n+1}=\sqrt{x_n+2}$ $\forall n=2,3,\ldots$

a. $x_1=1$ y $x_{n+1}=\sqrt{2x_n}$ $\forall n=2,3,\ldots$
:::
...
a. $x_1=1$ y $x_{n+1}=1+\frac{1}{x_n}$ $\forall n=1,2,\ldots$
b. $x_1=1$ y $x_{n+1}=\sqrt{1+x_n}$ $\forall n=1,2,\ldots$
:::
