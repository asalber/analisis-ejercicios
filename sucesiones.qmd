...
Demostrar, aplicando la definición de límite de una sucesión, que las siguientes sucesiones convergen a los valores dados.
...
Demostrar que si una sucesión de números reales positivos converge a $x$, entonces la sucesión de sus valores raíces cuadradas positivas converge a $\sqrt{x}$.
:::
