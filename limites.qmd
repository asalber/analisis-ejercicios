...
:::{#exr-cosecha}
$\star$
La cosecha de trigo de una plantación (en toneladas) depende de la cantidad de abono $x$ según la función $f(x)=T(1-\frac{1}{2}e^{-kx})$, donde $T$ es la extensión del terreno (en hectáreas) y $k$ es la proporción de humedad. ¿Para qué cantidad de abono se conseguiría una cosecha superior a $T$ toneladas de trigo? 
:::
