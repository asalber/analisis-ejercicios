...
a.  $f(x,y)=xy^2$ en $R=\{(x,y)\in \mathbb{R}^2: 0\leq x\leq 2, -x\leq y\leq x\}$.
...
El perfil de la sección transversal del ala de un avión viene dada por las funciones $\frac{(-1+x^2)}{10}$ y $\frac{1-x^4}{10}$ en metros.

a.  Calcular la superficie de un ala de 10 m de longitud.  

a.  Si la presión que soporta la parte inferior del ala viene dada por la función $P(x,y)=P(x,y)=ye^{-x^2}$, calcular la presión total que soporta el ala y la presión media.
:::
