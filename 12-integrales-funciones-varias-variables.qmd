...
a.  $\int_R \frac{y}{x}\,dA$, con $R=\left\{(x,y): 0\leq x\leq 2, 0\leq y\leq x^2\right\}$
:::
...
:::{.callout-tip collapse="true"}
## Solución
Como las funciones $y=x$ e $y=x^2$ se cortan en los puntos $(0,0)$ y $(1,1)$, la región de integración es $R=\{(x,y): 0\leq x\leq 1, x^2\leq y \leq x\}$. 
